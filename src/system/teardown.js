// Cascade planet teardown (planet + its moons, probes, cities, orbit lines).
...
import { bodies, cities, focusedBody, focusedCity, moons, planets, probes, setFocusedCity } from '../framework/state.js';
